...
public class Constant {
    ...
    public static String[] roleRule =
            new String[]{"Mỗi đêm Bảo Vệ được phép bảo vệ một người, người đó sẽ không bị ma sói cắn chết vào đêm đó. Nhưng không được bảo vệ một người 2 trong đêm liên tục. Bảo vệ được quyền bảo vệ chính mình. Người được bảo vệ sẽ không bị sói cắn chết. Nhưng nếu trúng bình giết của phù thuỷ hoặc bị thợ săn bắn trúng, người được bảo vệ vẫn chết.",
